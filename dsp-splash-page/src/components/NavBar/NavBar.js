...
class NavBar extends Component {
  state = {
    ...
    footer: [
      "hello@dsp.design",
      "Join us",
      "Design Service Professionals, PLLC 2019 All rights reserved"
    ],
  ...
  render() {
    return (
      <div id="nav" className="lightGrey-background">
        ...
        <div id="navCenter">
          <div id="navWords" className={this.state.navVisibility}>
            ...
            {this.state.buttons.map(button => (
              <Link
                to={button.to}
                id={button.id}
                className={`navQs ${this.state.navQsShow}`}
                onClick={() => {
                  this.hamburger();
                }}
              >
          ...
          <div id="navFooter" className="mt-3">
            ...
            <div id="socialIconWrapper">
              <a
                href="https://www.linkedin.com/company/designserviceprofessionalspllc/"
              ...
              <a
                href="https://www.instagram.com/dsp.design_virtual/"
                className="link socialIcon"
                target="blank"
              >
              ...
              <a
                href="https://www.facebook.com/dspdesignvirtual/"
                className="link socialIcon"
                target="blank"
              >
              ...
              <a
                href="https://twitter.com/dspdesignUSA"
                className="link socialIcon"
                target="blank"
              >
            ...
            <div id="navPLLC">
              <i className="far fa-copyright"></i> 2020 Design Service
              Professionals, PLLC All rights reserved
            </div>
          </div>
        </div>
        ...
        >
          <div
            id={this.state.hamLine1}
            className="hamLine charcoalish-background"
          ></div>
          <div
            id={this.state.hamLine2}
            className="hamLine charcoalish-background"
          ></div>
          <div
            id={this.state.hamLine3}
            className="hamLine charcoalish-background"
          ></div>
        </div>
        ...
        <div id="navSocialWrapper">
          <div
            id="navSocial"
            className={`charcoalish-text ${this.state.socialScroll}`}
            onMouseOver={() => {
              this.socialScroll();
            }}
            onMouseOut={() => {
          ...
          >
            ...
            <a href="https://www.facebook.com/dspdesignvirtual/" target="blank">
              <i className="fab fa-facebook"></i>
            </a>
            <a href="https://twitter.com/dspdesignUSA" target="blank">
              <i className="fab fa-twitter"></i>
            </a>
            <a id="emailAddress" className="link" href="tel:+15108722133">
              <img
            ...
            <a href="mailto:hello@dsp.design">
