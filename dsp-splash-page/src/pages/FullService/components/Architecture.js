    ...
    render() {
        return (
            <>
                            ...
                            {this.state.step1 ?
                                <>
                                    ...
                                    <div className={"whiteBg panel-body-2"}>
                                        ...
                                        {/* <div className="flex-right min-width mb-1"><Link className="btn custom-btn-2" to="/clients/contact">Contact Us</Link></div> */}
                ...
                <FullServiceNav arc={true} menu={this.state.menu} setMenu={this.setMenu}/>
